...
public class Test {
	...
	public static void main(String[] args) throws InterruptedException,
		...
		String URL = "https://sclub.jd.com/comment/productPageComments.action?&productId=6577495&score=0&sortType=5&page=0&pageSize=10";
		...
		try {
			IOUtil.writeFile(htmlSource, "html.txt", true);
		} catch (IOException e) {
